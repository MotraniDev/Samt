...
public sealed class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> Arabic = new(StringComparer.Ordinal)
    {
        ...
        ["PhaseBanner"] = "المرحلة 0–6: الهيكل، المحرك، المواقع، اليوم، الإشعارات، الأذان، القواعد، القبلة والهجري",
    };
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["PhaseBanner"] = "Phase 0–6: shell, engine, locations, today, notifications, adhan, rules, qibla & Hijri",
    };
}
